...
class TransactionsFilter:
    ...
    def transaction_by_date_filter(
        ...
        filter_parameters_requested = {"date_created__year": year, "date_created__month": month, "date_created__day": day}
        # removing parameters witn None value
        not_none_parameters = cls._get_not_none_values(filter_parameters_requested)
        # checking if parameters provided then filter will be applied with these parameters. Otherwise returns the current year and month.
